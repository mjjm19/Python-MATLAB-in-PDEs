...
[t2,X2] = ode45(f,[0 0.5],X(end,:));     % capturing steady
x = X2(:,1); y = X2(:,3);
...
xlabel('x [m]'); ylabel('y [m]');
title('Orbit with anisotropic bearings (k_x not equal to k_y)');
